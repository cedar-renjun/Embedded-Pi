...
set v_gen_root=%v_repo_root_self%\CoX\Shining\Shining_NuMicro\bsp\Shield_example
...
md %v_gen_root%\Shield\coide >>nul
move %v_gen_root%\Shield\coide_gen %v_gen_root%\Shield\coide\template >>nul
move %v_gen_root%\Shield\coide\template\cox_coide_empty_project.cob %v_gen_root%\Shield\coide\template\template.cob >>nul
echo completed
::echo --------------------------------------------
