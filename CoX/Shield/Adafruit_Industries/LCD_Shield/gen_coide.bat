...
set v_gen_root=%v_repo_root_self%\CoX\Shield\Adafruit_Industries\LCD_Shield\example
...
md %v_gen_root%\LEDBlink\coide >>nul
move %v_gen_root%\LEDBlink\coide_gen %v_gen_root%\LEDBlink\coide\template >>nul
move %v_gen_root%\LEDBlink\coide\template\cox_coide_empty_project.cob %v_gen_root%\LEDBlink\coide\template\template.cob >>nul
echo completed
::echo --------------------------------------------
