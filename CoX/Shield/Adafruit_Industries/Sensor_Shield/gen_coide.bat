...
set v_gen_root=%v_repo_root_self%\CoX\Shield\Adafruit_Industries\Motor_Shield\example
...
md %v_gen_root%\motor_stepping\coide >>nul
move %v_gen_root%\motor_stepping\coide_gen %v_gen_root%\motor_stepping\coide\template >>nul
move %v_gen_root%\motor_stepping\coide\template\cox_coide_empty_project.cob %v_gen_root%\motor_stepping\coide\template\template.cob >>nul
echo completed
::echo --------------------------------------------
